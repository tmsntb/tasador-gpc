export default async function handler(req, res) {
  ...
  let yearDesc = '';
  if (yearFrom && yearTo && yearFrom !== yearTo) yearDesc = ' anio ' + yearFrom + ' al ' + yearTo;
  ...
  const prompt = 'Busca precios de referencia en Argentina para: ' + vehiculo + '\n' +
    ...
    '\nBusca en Google y devuelve resultados reales:\n' +
    '1. Publicaciones de ' + vehiculo + ' en autos.mercadolibre.com.ar - 5 a 8 resultados con precio, km, anio y URL\n' +
    '2. Publicaciones de ' + vehiculo + ' en rosariogarage.com\n' +
    (infoautoLabel ? '3. Infoauto: usa datos del PDF' : '3. Precio referencia de infoauto.com.ar') + '\n' +
    ...
    '"mercadolibre":[{"anio":numero,"version":"texto","km":numero,"precio_ars":numero,"precio_usd":numero,"fecha_publicacion":"texto","ubicacion":"ciudad","url":"https://..."}],' +
    '"rosario_garage":[{"anio":numero,"version":"texto","km":numero,"precio_ars":numero,"precio_usd":numero,"fecha_publicacion":"texto","vendedor":"texto","url":"https://..."}]}\n' +
  ...
  try {
    ...
    if (!geminiRes.ok) {
      console.error('Gemini error:', JSON.stringify(geminiData).substring(0, 400));
